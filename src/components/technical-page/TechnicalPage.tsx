        ...
        <div className="bg-white rounded-xl shadow-sm p-8 min-h-[600px]">
          ...
          <div className="pt-5 space-y-4 text-gray-700 leading-relaxed mb-6">
            <p>
              ...
              codifique con el algoritmo de César, que consiste en sustituir cada
              letra por otra obtenida desplazando la posición de la actual un
              determinado número de posiciones dentro del abecedario. Ese
            ...
            <p>
              ...
              lleva dos argumentos: el primero la frase a cifrar y el segundo
              la clave. Debe devolver la frase cifrada.
            </p>
